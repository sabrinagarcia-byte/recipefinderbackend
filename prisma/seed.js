	...
	const recipes = [
		{
			...
			summary: 'A balanced bowl of fluffy quinoa, roasted veggies and healthy fats.',
			cover: 'https://res.cloudinary.com/dpfyoxbyv/image/upload/v1778070904/quinoa-veggie-bowl_ddfjs7.webp',
			servings: 2,
			prepMinutes: 10,
			cookMinutes: 15,
			ingredients: [
			...
			instructions: [
				{
					description: 'Cook quinoa according to package, fluff and cool slightly.',
					order: 1,
				},
				{
					description: 'In bowls layer spinach, quinoa, sweet potato and chickpeas.',
					order: 2,
				},
				{ description: 'Top with avocado slices and pumpkin seeds.', order: 3 },
				{
					description: 'Whisk olive oil, lemon juice, salt & pepper; drizzle over bowls.',
					order: 4,
				},
			],
		},
		{
			...
			summary: 'A 15-minute weeknight dinner of flaky salmon and tender asparagus.',
			cover: 'https://res.cloudinary.com/dpfyoxbyv/image/upload/v1778070904/salmon-asparagus_ol3rb1.webp',
			servings: 2,
			prepMinutes: 5,
			cookMinutes: 12,
			ingredients: [
		...
		},
		{
			...
			summary: 'A refreshing, protein-packed salad tossed in a lemon-olive oil dressing.',
			cover: 'https://res.cloudinary.com/dpfyoxbyv/image/upload/v1778070904/mediterranean-chickpea-salad_xzypc6.webp',
			servings: 2,
			prepMinutes: 10,
			cookMinutes: 0,
			ingredients: [
		...
		},
		{
			...
			cover: 'https://res.cloudinary.com/dpfyoxbyv/image/upload/v1778070904/greek-yogurt_fveiwl.webp',
			servings: 1,
			prepMinutes: 5,
			cookMinutes: 0,
			ingredients: [
		...
		},
		{
			...
			cover: 'https://res.cloudinary.com/dpfyoxbyv/image/upload/v1778070904/banana-pancakes_yrguai.webp',
			servings: 2,
			prepMinutes: 5,
			cookMinutes: 10,
			ingredients: [
		...
		},
		{
			...
			cover: 'https://res.cloudinary.com/dpfyoxbyv/image/upload/v1778070904/lentil-soup_lj0fkp.webp',
			servings: 4,
			prepMinutes: 10,
			cookMinutes: 20,
			ingredients: [
		...
		},
		{
			...
			summary: 'Smoky roasted sweet potatoes and black beans tucked into warm tortillas.',
			cover: 'https://res.cloudinary.com/dpfyoxbyv/image/upload/v1778070904/sweet-potato-tacos_qadv87.webp',
			servings: 3,
			prepMinutes: 10,
			cookMinutes: 15,
			ingredients: [
		...
		},
		{
			...
			cover: 'https://res.cloudinary.com/dpfyoxbyv/image/upload/v1778070904/avocado-tomato-wholegrain-toast_wrjzuo.webp',
			servings: 1,
			prepMinutes: 5,
			cookMinutes: 5,
			ingredients: [
